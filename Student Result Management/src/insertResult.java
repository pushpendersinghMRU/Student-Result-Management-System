...
public class insertResult extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Advanced Java");

        jLabel3.setText("Software Engineering");

        jLabel4.setText("Cloud computing");

        jLabel5.setText("VAPT");
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        String ajava=jTextField2.getText();
        String se=jTextField3.getText();
        String cc=jTextField4.getText();
        String vapt=jTextField5.getText();
        String pc=jTextField6.getText();
        try
        {
            ...
            if(rs.next())
            {
                st.executeUpdate("insert into result values('"+rollNo+"','"+ajava+"','"+se+"','"+cc+"','"+vapt+"','"+pc+"')");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                insertResult f6=new insertResult();
                f6.setVisible(true);
